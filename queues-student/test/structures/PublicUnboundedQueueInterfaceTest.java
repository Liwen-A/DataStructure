...
public class PublicUnboundedQueueInterfaceTest {
	...
	@Test
	public void testeque() throws Exception {
		Queue<Integer> q = new Queue<Integer>();
		q.enqueue(1);
		q.enqueue(2);
		q.enqueue(3);
	...
	public void Reverse() throws Exception {
		...
		q.enqueue(2);
		q.enqueue(3);
		Queue<Integer> p = (Queue<Integer>) q.reversed();
		assertEquals(3,(int)p.dequeue());
		assertEquals(2,(int)p.dequeue());
		assertEquals(1,(int)p.dequeue());
	}
